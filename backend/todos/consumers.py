...
class ToDoConsumer(AsyncWebsocketConsumer):
    """ ToDoConsumer is a class that provides full
    ...
    def desk_has_user(self):
        #: Checks if user is in requested desk.
        try:
    ...
    async def receive(self, text_data):
        #: Function to recieve all desk actions.
